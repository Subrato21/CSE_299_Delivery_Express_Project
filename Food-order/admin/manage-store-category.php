<?php include ('partials/menu.php'); ?>
    ...
    <div class="wrapper">
        ...
        <br> <br>
            <!-- Button to Add Admin-->
            <a href="<?php echo SITEURL;?>admin/add-store-category.php" class="btn-add">Add Category</a>
            <br>
            </br>
            <table class="tbl-full">
                ...
                if($count>0)
                {
                    ...
                    <tr>
                        ...
                        <td>
                            <?php 
                                ...
                                if($image_name!="")
                                {
                                    ...
                                    <img src="<?php echo SITEURL; ?>images/store-category/<?php echo $image_name; ?>"width="100px">
                        ...
                        <td>
                            <a href="<?php echo SITEURL; ?>admin/update-store-category.php?id=<?php echo $id; ?>" class="btn-secondary"> Update Category</a>
                            <a href="<?php echo SITEURL; ?>admin/delete-store-category.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name; ?>" class="btn-danger"> Delete Category</a>
                        </td>
                    </tr>
