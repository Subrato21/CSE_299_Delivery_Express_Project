        ...
        <div class="wrapper">
            ...
            <table class="tbl-full">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM tbl_store_order ORDER BY id DESC";
                    //Execute the Query
                ...
                if($count>0)
                {
                    ...
                    while($row=mysqli_fetch_assoc($res))
                    {
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="<?php echo SITEURL;?>admin/update-store-order.php?id=<?php echo $id; ?>" class="btn-secondary"> Update Order</a>
                            </td>
