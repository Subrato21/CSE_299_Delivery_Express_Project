<?php include('partials/menu.php'); ?>
        ...
        <div class="main-content">
            ...
            if(isset($_GET['id']))
            {
                ...
                $sql2 = "SELECT * FROM tbl_store_food WHERE id=$id";
                            ...
                            <td>
                                <?php
                                    ...
                                    if($current_image != "")
                                    {
                                        ...
                                        <img src="<?php echo SITEURL; ?>images/store-food/<?php echo $current_image; ?>"width="250px">
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name != "")
                    {
                        ...
                        //Rename the Image
                        $image_name = "Store_Food_Name_".rand(000, 999).'.'.$ext;

                        $source_path = $_FILES['image']['tmp_name'];
                        $destination_path = "../images/store-food/".$image_name;
                        ...
                        if($current_image !="")
                        {
                            ...
                            $remove_path = "../images/store-food/".$current_image;
                ...
                $sql3 = "UPDATE tbl_store_food SET
                title = '$title',
                ...
                if($res3==true)
                {
                    ...
                    echo "<script> window.location.href='manage-store-food.php';</script>";
