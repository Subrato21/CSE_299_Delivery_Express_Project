<?php include ('partials/menu.php'); ?>
    ...
    <div class="main-content">
        <div class="wrapper">
            <h1>Manage Store Iteams</h1>
            <br>
            </br>
            <!-- Button to Add Admin-->
            <a href="<?php echo SITEURL; ?>admin/add-store-food.php" class="btn-add">Add Iteam</a>
        ...
        <br>
            ...
            <table class="tbl-full">
                ...
                $sql = "SELECT * FROM tbl_store_food";
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                else
                                {
                                    ...
                                    <img src="<?php echo SITEURL; ?>images/store-food/<?php echo $image_name; ?>"width="100px">
                            ...
                            <td>
                            <a href="<?php echo SITEURL; ?>admin/update-store-food.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name; ?>" class="btn-secondary"> Update Iteam</a>
                            <a href="<?php echo SITEURL; ?>admin/delete-store-food.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name; ?>" class="btn-danger"> Delete Iteam</a>
                            </td>
                        </tr>
                ...
                else
                {
                    ...
                    echo" <tr><td colspan='7' class='error'>Iteam not Added Yet.</td></tr>";
                }
