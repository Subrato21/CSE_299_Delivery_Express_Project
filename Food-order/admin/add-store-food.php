    ...
    <div class="wrapper">
        ...
        <table class="tbl-30"> 
            <tr>
                <td>Title: </td>
                <td>
                    <input type="text" name="title" placeholder="Iteam Title">
                </td>
            </tr>
            ...
            <tr>
                <td>Description: </td>
                <td>
                    <textarea name="description"  cols="30" rows="5" placeholder="Add description of the iteam"></textarea>
                </td>
            </tr>
                ...
                <td>
                    <select name="category">
                        ...
                        <?php 
                            ...
                            $sql = "SELECT * FROM tbl_store_category WHERE active='Yes'";
                    ...
                    <tr>
                            <td colspan="2">
                            <input type="submit" name="submit" value="Add Iteam" class="btn-secondary"></td>
                            </td>
                    </tr>
...

        {
                ...
                //2. Upload the Image if selected
                 ...
                 if(isset($_FILES['image']['name']))
                 {
                     ...
                     if($image_name != "")
                     {
                         ...
                         $image_name = "Iteam_Name_".rand(000, 999).'.'.$ext; //Create new image name
 
                         $src = $_FILES['image']['tmp_name'];
                         $dst = "../images/store-food/".$image_name;
                         ...
                         if($upload==false)
                         {
                             ...
                             header("location: ".SITEURL.'admin/add-store-food.php');
                             //Stop the process
                             die();
                ...
                $sql2 = "INSERT INTO tbl_store_food SET
                title = '$title',
                ...
                if($res2==true)
                {
                    ...
                    $_SESSION['add']= '<div class="ok">Iteam Added Successfully</div>';
                ...
                else
                {
                    ...
                    //Create a Session Variable to Display Message
                    $_SESSION['add']= '<div class="error">Failed to Add Iteam</div>';
